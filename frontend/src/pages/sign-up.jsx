...
export const SignUp = () => {
    ...
    const onRegister = (e) => {
        ...
        // Here you can send the `usersData` to your backend API if needed.
    }
    ...
    return (
        <section className="signup-section">
            ...
            <div className="form-background">
                ...
                <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2" style={{ width: "85%" }} onSubmit={onRegister}>
